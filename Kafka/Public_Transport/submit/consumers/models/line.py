...
class Line:
    ...
    def process_message(self, message):
        ...
        elif "from_" in message.topic(): # Set the conditional to the arrival topic
            self._handle_arrival(message)
        elif message.topic() == "turnstile": # Set the conditional to the KSQL Turnstile Summary Topic
