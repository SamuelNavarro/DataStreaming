...
class KafkaConsumer:
    ...
    def __init__(
        ...
        self.broker_properties = {
            ...
            'group.id': 'consumer_transportation'
        }
    ...
    def _consume(self):
        ...
        if msg is None:
            ...
            print(f"consumed msg: {msg.key()}: {msg.value()}")
            self.message_handler(msg)
            return 1
        logger.info("_consume goes throughout the end")
    ...
    def close(self):
        ...
        self.consumer.close()
        logger.info("consumer close completed")